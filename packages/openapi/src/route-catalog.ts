...
export const FRAMEKIT_ROUTE_CATALOG = [
  ...
  route("GET", "/api/auth/users", "auth"), route("POST", "/api/auth/users", "auth"), route("PATCH", "/api/auth/users/{id}", "auth"), route("DELETE", "/api/auth/users/{id}", "auth"), route("POST", "/api/auth/users/{id}/password", "auth"), route("POST", "/api/auth/users/{id}/recovery", "auth"),
  route("GET", "/api/auth/roles", "auth"), route("POST", "/api/auth/roles", "auth"), route("PATCH", "/api/auth/roles/{id}", "auth"), route("DELETE", "/api/auth/roles/{id}", "auth"),
